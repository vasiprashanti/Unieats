...
export default function OrderDetailsModal({
  ...
  // Use pre-calculated values from backend instead of recalculating
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-md max-h-[90vh] rounded-xl border border-gray-200 bg-gray-200 text-gray-900 shadow-lg flex flex-col"
        style={{
          fontFamily:
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            borderBottomColor: "hsl(240, 6%, 90%)",
          }}
        >
          <h3
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
          ...
          <div>
            ...
            >
              <span style={{ color: "hsl(240, 4%, 46%)", fontSize: "14px" }}>
                Customer Name:
              </span>
            ...
            <div className="flex justify-between" style={{ marginBottom: "0" }}>
              ...
              <span style={{ fontWeight: "500", fontSize: "14px" }}>
                {order.customerAddress?.block || "N/A"}
              </span>
            </div>
          </div>
          ...
          <hr
            style={{
              border: "0",
              borderTop: "1px solid hsl(240, 6%, 90%)",
              margin: "0",
            }}
          />
              ...
              {order.items?.map((it, idx) => (
                ...
                >
                  <div className="flex gap-2">
                    <span
                      style={{ color: "hsl(14, 100%, 57%)", fontWeight: "600" }}
                    >
                      {it.qty}x
                    </span>
                    <span>{it.name}</span>
